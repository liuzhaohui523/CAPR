...
from .hmvit.Transformer import ViTVQ
from .hmvit.pose_net import get_pose_resnet
from .hmvit.poseRefine import get_pose_refine
...
ModelOutput = namedtuple(
    ...
    field_names=['pred_shape', 'pred_theta_mats', 'pred_phi', 'pred_delta_shape', 'pred_leaf',
                 ...
                 'uvd_heatmap', 'transl', 'img_feat', "x_res","initial_view_B","initial_view_L","initial_view_R"]
)
...
class HeatERCam(nn.Module):
    def __init__(self, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.num_layers =kwargs['POSE']['NUM_LAYERS']
        self.input_dim =kwargs['POSE']['INPUT_DIM']
