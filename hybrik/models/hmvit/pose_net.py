...
class PoseNet(nn.Module):
    ...
    def __init__(self,block,layers,**kwargs):
        ...
        self.final_layer =nn.Conv2d(in_channels=256,
                                    out_channels=17,kernel_size=1,stride=1,padding=0)
...
def get_pose_resnet(num_layers ,**kwargs):
    block_class, layers = resnet_spec[num_layers]

    model = PoseNet(block_class, layers, **kwargs)
...
if __name__ == '__main__':
    ...
    model =get_pose_resnet(num_layers=50)
